...
#define USERSPACE_STACK_SIZE 0x8000
#define USERSPACE_STACK_TOP (KERNEL_SPACE_ADDR)
#define USERSPACE_STACK (USERSPACE_STACK_TOP - USERSPACE_STACK_SIZE)
// 100mb
#define USERSPACE_SHARED_MEM_SIZE 0x6400000
// -0x1000 for unmapped page (overflow guard)
#define USERSPACE_SHARED_MEM_TOP (USERSPACE_STACK - 0x1000)
#define USERSPACE_SHARED_MEM (USERSPACE_SHARED_MEM_TOP - USERSPACE_SHARED_MEM_SIZE)
