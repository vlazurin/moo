...
#define FAT16_DIRECTORY_ENTRY_COUNT 512
#define FAT16_ENTRY_SIZE 32
#define FAT16_ROOT_DIRECTORY_SIZE 0x4000
#define FAT16_ROOT_DIRECTORY_SECTORS (FAT16_ROOT_DIRECTORY_SIZE / SECTOR_SIZE)
#define FAT16_BYTES_PER_FAT_ENTRY 2
